...
RSpec.feature "React Handling", type: :feature, js: true do
  feature 'Logged as User Admin' do
    before :all do
      ...
      @machine3 = create(:machine, machine_category: category_machine2, caces: 'Categorie B', description: 'Bla bla bla je suis un pont roulant de categorie B')
      @machine4 = create(:machine, machine_category: category_machine3, caces: 'Categorie A', description: 'Bla bla bla je suis un pont fixe de categorie A')
    end
