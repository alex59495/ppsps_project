class Api::V1::MachinesController < Api::V1::BaseController
  def index
    ...
    @machines = policy_scope(Machine.all.where.not(id: conductor_ids).includes(:machine_category).where(machine_category: MachineCategory.find_by(name: params[:category])))
  end
